...
import { Play, Pause, Eye, FileText, CheckCircle, AlertTriangle, Clock, Monitor, FlaskConical, AlertTriangle as AlertTriangle } from 'lucide-react'
  ...
  if (previewShot) {
    ...
    return (
      <RenderPreview 
        mode="comprehensive"
        onUploadSequence={() => {}}
        onAnalyzeFrame={() => Promise.resolve({
          frame_index: 0,
          timestamp: 0,
          metrics: { ssim: 0.9, opticalFlowStability: 0.85, textLegibility: 0.9, colorAccuracy: 0.95, motionArtifacts: 0, compressionArtifacts: 0 },
          issues: [],
          overall_score: 0.9,
